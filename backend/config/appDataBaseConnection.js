...
mongoose.connect('mongodb+srv://FaziTestingDB:Rehman1!!@testingcluster.uzquj.mongodb.net/myFirstDatabase?retryWrites=true&w=majority',{useNewUrlParser:true, useUnifiedTopology:true},(error)=>{
    if(!error){
